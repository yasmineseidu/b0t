          ...
          functions: [
            {
              ...
              example: "const result = await createCampaign({\n  apiKey: 'your-api-key',\n  name: 'Q1 Outreach Campaign',\n  from_email: 'sales@company.com',\n  schedule: {\n    days: ['monday', 'tuesday', 'wednesday'],\n    start_hour: 9,\n    end_hour: 17,\n    timezone: 'America/New_York'\n  }\n});",
            },
            {
              name: 'listCampaigns',
              description: "List all campaigns in your Instantly.ai account",
              signature: 'listCampaigns(options)',
              example: "const result = await listCampaigns({\n  apiKey: 'your-api-key',\n  limit: 50,\n  offset: 0\n});",
            },
            {
              name: 'getCampaign',
              description: "Get details of a specific campaign",
              signature: 'getCampaign(options)',
              example: "const result = await getCampaign({\n  apiKey: 'your-api-key',\n  campaignId: 'camp_123456'\n});",
            },
            {
              name: 'updateCampaign',
              description: "Update an existing campaign",
              signature: 'updateCampaign(options)',
              example: "const result = await updateCampaign({\n  apiKey: 'your-api-key',\n  campaignId: 'camp_123456',\n  name: 'Updated Campaign Name'\n});",
            },
            {
              name: 'deleteCampaign',
              description: "Delete a campaign permanently",
              signature: 'deleteCampaign(options)',
              example: "const result = await deleteCampaign({\n  apiKey: 'your-api-key',\n  campaignId: 'camp_123456'\n});",
            },
            {
              name: 'activateCampaign',
              description: "Activate a paused or draft campaign to start sending emails",
              signature: 'activateCampaign(options)',
              example: "const result = await activateCampaign({\n  apiKey: 'your-api-key',\n  campaignId: 'camp_123456'\n});",
            },
            {
              name: 'pauseCampaign',
              description: "Pause an active campaign to stop sending emails",
              signature: 'pauseCampaign(options)',
              example: "const result = await pauseCampaign({\n  apiKey: 'your-api-key',\n  campaignId: 'camp_123456'\n});",
            },
            {
              name: 'searchCampaignByContact',
              description: "Search for campaigns that contain a specific contact email",
              signature: 'searchCampaignByContact(options)',
              example: "const result = await searchCampaignByContact({\n  apiKey: 'your-api-key',\n  email: 'contact@example.com'\n});",
            },
            {
              name: 'duplicateCampaign',
              description: "Duplicate an existing campaign with all its settings",
              signature: 'duplicateCampaign(options)',
              example: "const result = await duplicateCampaign({\n  apiKey: 'your-api-key',\n  campaignId: 'camp_123456'\n});",
            },
            {
              name: 'stopCampaignForLead',
              description: "Stop a campaign for a specific lead",
              signature: 'stopCampaignForLead(options)',
              example: "const result = await stopCampaignForLead({\n  apiKey: 'your-api-key',\n  campaignId: 'camp_123456',\n  leadId: '019a861c-5abb-76fb-a399-6c551d19c0cf'\n});",
            },
            {
              name: 'getLaunchedCount',
              description: "Get the count of launched (active) campaigns",
              signature: 'getLaunchedCount(options)',
              example: "const result = await getLaunchedCount({\n  apiKey: 'your-api-key'\n});\nconsole.log(`You have ${result.data.count} launched campaigns`);",
            },
            {
              name: 'addLead',
              description: "Add a new lead to a campaign",
              signature: 'addLead(options)',
              example: "const result = await addLead({\n  apiKey: 'your-api-key',\n  campaignId: 'camp_123456',\n  email: 'lead@example.com',\n  first_name: 'John',\n  last_name: 'Doe',\n  company: 'Acme Corp'\n});",
            },
            {
              name: 'deleteLead',
              description: "Remove a lead by its UUID",
              signature: 'deleteLead(options)',
              example: "const result = await deleteLead({\n  apiKey: 'your-api-key',\n  leadId: '019a861c-5abb-76fb-a399-6c551d19c0cf'\n});",
            },
            {
              name: 'getLead',
              description: "Get details of a specific lead by UUID",
              signature: 'getLead(options)',
              example: "const result = await getLead({\n  apiKey: 'your-api-key',\n  leadId: '019a861c-5abb-76fb-a399-6c551d19c0cf'\n});",
            },
            {
              name: 'updateLead',
              description: "Update a lead's information",
              signature: 'updateLead(options)',
              example: "const result = await updateLead({\n  apiKey: 'your-api-key',\n  leadId: '019a861c-5abb-76fb-a399-6c551d19c0cf',\n  first_name: 'Updated Name',\n  company: 'New Company'\n});",
            },
            {
              name: 'listLeads',
              description: "List leads (optionally filtered by campaign)",
              signature: 'listLeads(options)',
              example: "// List all leads\nconst allLeads = await listLeads({\n  apiKey: 'your-api-key',\n  limit: 100\n});\n\n// List leads in a specific campaign\nconst campaignLeads = await listLeads({\n  apiKey: 'your-api-key',\n  campaignId: 'camp_123456',\n  limit: 100,\n  skip: 0\n});",
            },
            {
              name: 'mergeLeads',
              description: "Merge duplicate leads into a single lead record",
              signature: 'mergeLeads(options)',
              example: "const result = await mergeLeads({\n  apiKey: 'your-api-key',\n  leadId: '019a861c-5abb-76fb-a399-6c551d19c0cf',\n  duplicateLeadId: '019a861c-5ff5-7c3c-88be-2269f99ed8d5'\n});",
            },
            {
              name: 'updateLeadInterestStatus',
              description: "Update a lead's interest status",
              signature: 'updateLeadInterestStatus(options)',
              example: "const result = await updateLeadInterestStatus({\n  apiKey: 'your-api-key',\n  leadId: '019a861c-5abb-76fb-a399-6c551d19c0cf',\n  status: 'interested'\n});",
            },
            {
              name: 'removeLeadFromSubsequence',
              description: "Remove a lead from an email subsequence",
              signature: 'removeLeadFromSubsequence(options)',
              example: "const result = await removeLeadFromSubsequence({\n  apiKey: 'your-api-key',\n  leadId: '019a861c-5abb-76fb-a399-6c551d19c0cf',\n  campaignId: 'camp_123456'\n});",
            },
            {
              name: 'bulkAssignLeads',
              description: "Bulk assign multiple leads to organization users",
              signature: 'bulkAssignLeads(options)',
              example: "const result = await bulkAssignLeads({\n  apiKey: 'your-api-key',\n  leadIds: ['019a861c-5abb-76fb-a399-6c551d19c0cf', '019a861c-5ff5-7c3c-88be-2269f99ed8d5'],\n  organizationUserIds: ['org_user_123', 'org_user_456'],\n  campaignId: 'camp_123456'\n});",
            },
            {
              name: 'moveLeads',
              description: "Move multiple leads to a different campaign or lead list",
              signature: 'moveLeads(options)',
              example: "// Move leads to a campaign\nconst result = await moveLeads({\n  apiKey: 'your-api-key',\n  leadIds: ['019a861c-5abb-76fb-a399-6c551d19c0cf', '019a861c-5ff5-7c3c-88be-2269f99ed8d5'],\n  campaignId: 'camp_789012'\n});\n\n// Move leads to a list\nconst result = await moveLeads({\n  apiKey: 'your-api-key',\n  leadIds: ['019a861c-5abb-76fb-a399-6c551d19c0cf'],\n  listId: 'list_456789'\n});",
            },
            {
              name: 'addLeadToSubsequence',
              description: "Add a lead to a specific subsequence/step in a campaign",
              signature: 'addLeadToSubsequence(options)',
              example: "const result = await addLeadToSubsequence({\n  apiKey: 'your-api-key',\n  leadId: '019a861c-5abb-76fb-a399-6c551d19c0cf',\n  campaignId: 'camp_123456',\n  subsequenceId: 'subseq_789012'\n});",
            },
            {
              name: 'bulkAddLeads',
              description: "Add multiple leads in bulk to a campaign or lead list",
              signature: 'bulkAddLeads(options)',
              example: "// Add leads to a campaign\nconst result = await bulkAddLeads({\n  apiKey: 'your-api-key',\n  campaignId: 'camp_123456',\n  leads: [\n    { email: 'lead1@example.com', first_name: 'John', last_name: 'Doe', company: 'Acme Corp' },\n    { email: 'lead2@example.com', first_name: 'Jane', last_name: 'Smith', company: 'Tech Inc' }\n  ]\n});\n\n// Add leads to a list\nconst result = await bulkAddLeads({\n  apiKey: 'your-api-key',\n  listId: 'list_456789',\n  leads: [\n    { email: 'lead3@example.com', first_name: 'Bob', company: 'StartupXYZ' }\n  ]\n});",
            },
            {
              name: 'verifyEmail',
              description: "Verify a single email address for deliverability and validity",
              signature: 'verifyEmail(options)',
              example: "const result = await verifyEmail({\n  apiKey: 'your-api-key',\n  email: 'prospect@example.com'\n});\nconsole.log(`Email status: ${result.data.status}`);\nconsole.log(`Is disposable: ${result.data.is_disposable}`);",
            },
            {
              name: 'getEmailVerification',
              description: "Get the verification result for a previously verified email",
              signature: 'getEmailVerification(options)',
              example: "const result = await getEmailVerification({\n  apiKey: 'your-api-key',\n  email: 'prospect@example.com'\n});",
            },
            {
              name: 'createLeadList',
              description: "Create a new lead list to organize your prospects",
              signature: 'createLeadList(options)',
              example: "const result = await createLeadList({\n  apiKey: 'your-api-key',\n  name: 'Q1 2025 Prospects',\n  description: 'High-priority leads for Q1 outreach'\n});",
            },
            {
              name: 'listLeadLists',
              description: "List all lead lists in your account",
              signature: 'listLeadLists(options)',
              example: "const result = await listLeadLists({\n  apiKey: 'your-api-key',\n  limit: 50,\n  offset: 0\n});",
            },
            {
              name: 'getLeadList',
              description: "Get details of a specific lead list",
              signature: 'getLeadList(options)',
              example: "const result = await getLeadList({\n  apiKey: 'your-api-key',\n  listId: 'list_123456'\n});",
            },
            {
              name: 'updateLeadList',
              description: "Update a lead list's name or description",
              signature: 'updateLeadList(options)',
              example: "const result = await updateLeadList({\n  apiKey: 'your-api-key',\n  listId: 'list_123456',\n  name: 'Updated List Name',\n  description: 'New description'\n});",
            },
            {
              name: 'deleteLeadList',
              description: "Delete a lead list permanently",
              signature: 'deleteLeadList(options)',
              example: "const result = await deleteLeadList({\n  apiKey: 'your-api-key',\n  listId: 'list_123456'\n});",
            },
            {
              name: 'getLeadListVerificationStats',
              description: "Get email verification statistics for all leads in a list",
              signature: 'getLeadListVerificationStats(options)',
              example: "const result = await getLeadListVerificationStats({\n  apiKey: 'your-api-key',\n  listId: 'list_123456'\n});\nconsole.log(`Total leads: ${result.data.total_leads}`);\nconsole.log(`Valid: ${result.data.valid_count}`);\nconsole.log(`Invalid: ${result.data.invalid_count}`);",
            },
            {
              name: 'replyEmail',
              description: "Send a reply to an email in Instantly.ai Unibox",
              signature: 'replyEmail(options)',
              example: "const result = await replyEmail({\n  apiKey: 'your-api-key',\n  emailId: 'email_123456',\n  eaccount: 'yasmineseidu@gmail.com',\n  body: 'Thanks for reaching out! I will get back to you soon.',\n  html_body: '<p>Thanks for reaching out! I will get back to you soon.</p>'\n});",
            },
            {
              name: 'forwardEmail',
              description: "Forward an email from Instantly.ai Unibox to other recipients",
              signature: 'forwardEmail(options)',
              example: "const result = await forwardEmail({\n  apiKey: 'your-api-key',\n  emailId: 'email_123456',\n  eaccount: 'yasmineseidu@gmail.com',\n  to_address_email_list: ['colleague@company.com', 'manager@company.com'],\n  message: 'FYI - please review this inquiry'\n});",
            },
            {
              name: 'listEmails',
              description: "List emails in your Instantly.ai Unibox with optional filtering",
              signature: 'listEmails(options)',
              example: "// List all emails\nconst allEmails = await listEmails({\n  apiKey: 'your-api-key',\n  limit: 50\n});\n\n// List only unread emails\nconst unreadEmails = await listEmails({\n  apiKey: 'your-api-key',\n  is_read: false,\n  limit: 20\n});",
            },
            {
              name: 'getEmail',
              description: "Get full details of a specific email from Unibox",
              signature: 'getEmail(options)',
              example: "const result = await getEmail({\n  apiKey: 'your-api-key',\n  emailId: 'email_123456'\n});",
            },
            {
              name: 'updateEmail',
              description: "Update email properties (e.g., mark as read/unread)",
              signature: 'updateEmail(options)',
              example: "// Mark email as read\nconst result = await updateEmail({\n  apiKey: 'your-api-key',\n  emailId: 'email_123456',\n  is_unread: 0\n});\n\n// Mark email as unread\nconst result = await updateEmail({\n  apiKey: 'your-api-key',\n  emailId: 'email_123456',\n  is_unread: 1\n});",
            },
            {
              name: 'deleteEmail',
              description: "Delete an email from Instantly.ai Unibox",
              signature: 'deleteEmail(options)',
              example: "const result = await deleteEmail({\n  apiKey: 'your-api-key',\n  emailId: 'email_123456'\n});",
            },
            {
              name: 'getUnreadCount',
              description: "Get the count of unread emails in your Unibox",
              signature: 'getUnreadCount(options)',
              example: "const result = await getUnreadCount({\n  apiKey: 'your-api-key'\n});\nconsole.log(`You have ${result.data.count} unread emails`);",
            },
            {
              name: 'markThreadAsRead',
              description: "Mark an entire email thread as read in Unibox",
              signature: 'markThreadAsRead(options)',
              example: "const result = await markThreadAsRead({\n  apiKey: 'your-api-key',\n  threadId: 'thread_123456'\n});",
            },
            {
              name: 'getWarmupAnalytics',
              description: "Get warmup analytics for email accounts",
              signature: 'getWarmupAnalytics(options)',
              example: "const result = await getWarmupAnalytics({\n  apiKey: 'your-api-key',\n  emails: ['sender@example.com', 'sales@company.com']\n});",
            },
            {
              name: 'testVitals',
              description: "Test account vitals to verify email deliverability and health",
              signature: 'testVitals(options)',
              example: "const result = await testVitals({\n  apiKey: 'your-api-key',\n  email: 'sender@example.com'\n});",
            },
            {
              name: 'getCampaignAnalytics',
              description: "Get comprehensive analytics for a specific campaign",
              signature: 'getCampaignAnalytics(options)',
              example: "const result = await getCampaignAnalytics({\n  apiKey: 'your-api-key',\n  campaignId: 'camp_123456'\n});",
            },
            {
              name: 'getCampaignAnalyticsOverview',
              description: "Get overview analytics for a campaign with summary metrics",
              signature: 'getCampaignAnalyticsOverview(options)',
              example: "const result = await getCampaignAnalyticsOverview({\n  apiKey: 'your-api-key',\n  campaignId: 'camp_123456'\n});",
            },
            {
              name: 'getCampaignAnalyticsDaily',
              description: "Get daily analytics breakdown for a campaign",
              signature: 'getCampaignAnalyticsDaily(options)',
              example: "const result = await getCampaignAnalyticsDaily({\n  apiKey: 'your-api-key',\n  campaignId: 'camp_123456',\n  startDate: '2025-01-01',\n  endDate: '2025-01-31'\n});",
            },
            {
              name: 'getCampaignAnalyticsSteps',
              description: "Get analytics breakdown by campaign steps/sequences",
              signature: 'getCampaignAnalyticsSteps(options)',
              example: "const result = await getCampaignAnalyticsSteps({\n  apiKey: 'your-api-key',\n  campaignId: 'camp_123456'\n});",
            },
            {
              name: 'createAccount',
              description: "Create a new email account in Instantly.ai",
              signature: 'createAccount(options)',
              example: "const result = await createAccount({\n  apiKey: 'your-api-key',\n  email: 'sender@example.com',\n  first_name: 'John',\n  last_name: 'Doe',\n  provider_code: 1, // Numeric provider code\n  smtp_host: 'smtp.gmail.com',\n  smtp_port: 587,\n  smtp_username: 'sender@example.com',\n  smtp_password: 'app-password',\n  imap_host: 'imap.gmail.com',\n  imap_port: 993,\n  imap_username: 'sender@example.com',\n  imap_password: 'app-password'\n});",
            },
            {
              name: 'listAccounts',
              description: "List all email accounts in your Instantly.ai workspace",
              signature: 'listAccounts(options)',
              example: "const result = await listAccounts({\n  apiKey: 'your-api-key',\n  limit: 50,\n  offset: 0\n});",
            },
            {
              name: 'getAccount',
              description: "Get details of a specific email account",
              signature: 'getAccount(options)',
              example: "const result = await getAccount({\n  apiKey: 'your-api-key',\n  email: 'sender@example.com'\n});",
            },
            {
              name: 'updateAccount',
              description: "Update email account settings",
              signature: 'updateAccount(options)',
              example: "const result = await updateAccount({\n  apiKey: 'your-api-key',\n  email: 'sender@example.com',\n  daily_limit: 50,\n  warmup_enabled: true\n});",
            },
            {
              name: 'deleteAccount',
              description: "Delete an email account from Instantly.ai",
              signature: 'deleteAccount(options)',
              example: "const result = await deleteAccount({\n  apiKey: 'your-api-key',\n  email: 'sender@example.com'\n});",
            },
            {
              name: 'enableWarmup',
              description: "Enable email warmup for an account to improve deliverability",
              signature: 'enableWarmup(options)',
              example: "const result = await enableWarmup({\n  apiKey: 'your-api-key',\n  email: 'sender@example.com'\n});",
            },
            {
              name: 'disableWarmup',
              description: "Disable email warmup for an account",
              signature: 'disableWarmup(options)',
              example: "const result = await disableWarmup({\n  apiKey: 'your-api-key',\n  email: 'sender@example.com'\n});",
            },
            {
              name: 'fixAccounts',
              description: "Mark multiple accounts as fixed after resolving connection issues",
              signature: 'fixAccounts(options)',
              example: "const result = await fixAccounts({\n  apiKey: 'your-api-key',\n  emails: ['account1@example.com', 'account2@example.com']\n});",
            },
            {
              name: 'deleteMultipleAccounts',
              description: "Delete multiple email accounts in bulk",
              signature: 'deleteMultipleAccounts(options)',
              example: "const result = await deleteMultipleAccounts({\n  apiKey: 'your-api-key',\n  emails: ['old1@example.com', 'old2@example.com']\n});",
            },
            {
              name: 'updateCustomTrackingDomain',
              description: "Update custom tracking domain for an email account",
              signature: 'updateCustomTrackingDomain(options)',
              example: "const result = await updateCustomTrackingDomain({\n  apiKey: 'your-api-key',\n  email: 'sender@example.com',\n  custom_tracking_domain: 'track.mydomain.com'\n});",
            },
          ],
        },
        {
      ...
      modules: [
        {
          ...
          functions: [
            {
              name: 'checkApiKey',
              description: "Verify that your HeyReach API key is valid and working",
              signature: 'checkApiKey(options?)',
              example: "const status = await checkApiKey({ apiKey: 'your_key' });\nconsole.log(status.valid); // true",
            },
            {
              name: 'getCampaigns',
              description: "Retrieve all campaigns with pagination",
              signature: 'getCampaigns(options?)',
              example: "const campaigns = await getCampaigns({ offset: 0, limit: 50 });\nconsole.log(campaigns.campaigns.length);",
            },
            {
              name: 'getCampaignById',
              description: "Get detailed information about a specific campaign",
              signature: 'getCampaignById(options)',
              example: "const campaign = await getCampaignById({ campaignId: 90486 });\nconsole.log(campaign.name, campaign.status);",
            },
            {
              name: 'getActiveCampaigns',
              description: "Find campaigns ready for adding leads (ACTIVE status with LinkedIn senders)",
              signature: 'getActiveCampaigns(options?)',
              example: "const activeCampaigns = await getActiveCampaigns();\nconsole.log(activeCampaigns.campaigns);",
            },
            {
              name: 'resumeCampaign',
              description: "Resume a paused campaign",
              signature: 'resumeCampaign(options)',
              example: "const result = await resumeCampaign({ campaignId: 90486 });\nconsole.log(result.status); // \"ACTIVE\"",
            },
            {
              name: 'pauseCampaign',
              description: "Pause an active campaign",
              signature: 'pauseCampaign(options)',
              example: "const result = await pauseCampaign({ campaignId: 90486 });\nconsole.log(result.status); // \"PAUSED\"",
            },
            {
              name: 'addLeadToCampaign',
              description: "Add leads to an existing ACTIVE campaign (max 100 leads per request)",
              signature: 'addLeadToCampaign(options)',
              example: "const result = await addLeadToCampaign({\n  campaignId: 90486,\n  leads: [{\n    firstName: \"John\",\n    lastName: \"Doe\",\n    linkedinUrl: \"https://www.linkedin.com/in/john-doe\",\n    customFields: [{ name: \"pain_point\", value: \"lead generation\" }]\n  }]\n});",
            },
            {
              name: 'getLeadsForCampaign',
              description: "Retrieve leads from a campaign with pagination",
              signature: 'getLeadsForCampaign(options)',
              example: "const leads = await getLeadsForCampaign({ campaignId: 90486, page: 1, limit: 50 });\nconsole.log(leads.leads.length);",
            },
            {
              name: 'stopLeadInCampaign',
              description: "Remove/stop a lead from a campaign",
              signature: 'stopLeadInCampaign(options)',
              example: "const result = await stopLeadInCampaign({ campaignId: 90486, leadId: \"lead_123\" });",
            },
            {
              name: 'getLists',
              description: "Retrieve all lead and company lists",
              signature: 'getLists(options?)',
              example: "const lists = await getLists({ offset: 0, limit: 50 });\nconsole.log(lists.lists);",
            },
            {
              name: 'getListById',
              description: "Get specific list details",
              signature: 'getListById(options)',
              example: "const list = await getListById({ listId: 12345 });\nconsole.log(list.name, list.count);",
            },
            {
              name: 'createEmptyList',
              description: "Create a new lead or company list",
              signature: 'createEmptyList(options)',
              example: "const list = await createEmptyList({ name: \"Q1 Prospects\", type: \"LEAD\" });\nconsole.log(list.listId);",
            },
            {
              name: 'addLeadsToList',
              description: "Add up to 100 leads to a list",
              signature: 'addLeadsToList(options)',
              example: "const result = await addLeadsToList({\n  listId: 12345,\n  leads: [{ firstName: \"Jane\", lastName: \"Smith\", linkedinUrl: \"...\" }]\n});",
            },
            {
              name: 'addLeadsToListV2',
              description: "Add leads with detailed statistics on success/failure (enhanced version)",
              signature: 'addLeadsToListV2(options)',
              example: "const result = await addLeadsToListV2({\n  listId: 12345,\n  leads: [{ firstName: \"John\", lastName: \"Doe\", profileUrl: \"...\" }]\n});\nconsole.log(result.statistics); // { added: 1, updated: 0, failed: 0 }",
            },
            {
              name: 'getLeadsFromList',
              description: "Get paginated leads from a specific list",
              signature: 'getLeadsFromList(options)',
              example: "const leads = await getLeadsFromList({ listId: 12345, offset: 0, limit: 50 });",
            },
            {
              name: 'deleteLeadFromList',
              description: "Remove a lead from a list",
              signature: 'deleteLeadFromList(options)',
              example: "await deleteLeadFromList({ listId: 12345, leadId: \"lead_123\" });",
            },
            {
              name: 'getCompaniesFromList',
              description: "Get companies from a company list",
              signature: 'getCompaniesFromList(options)',
              example: "const companies = await getCompaniesFromList({ listId: 12346, offset: 0, limit: 50 });",
            },
            {
              name: 'getListsForLead',
              description: "Get all lists containing a specific lead",
              signature: 'getListsForLead(options)',
              example: "const lists = await getListsForLead({ leadId: \"lead_123\" });",
            },
            {
              name: 'getLeadDetails',
              description: "Get detailed lead profile information",
              signature: 'getLeadDetails(options)',
              example: "const lead = await getLeadDetails({ linkedinUrl: \"https://www.linkedin.com/in/john-doe\" });\nconsole.log(lead.email, lead.company);",
            },
            {
              name: 'getConversations',
              description: "Retrieve LinkedIn conversations with advanced filtering",
              signature: 'getConversations(options?)',
              example: "const conversations = await getConversations({\n  filters: { campaignId: 90486, hasReplies: true },\n  limit: 50\n});",
            },
            {
              name: 'getConversation',
              description: "Get a specific conversation with all messages",
              signature: 'getConversation(options)',
              example: "const conversation = await getConversation({ conversationId: \"conv_456\" });\nconsole.log(conversation.messages);",
            },
            {
              name: 'sendMessage',
              description: "Send a direct message to a lead",
              signature: 'sendMessage(options)',
              example: "await sendMessage({\n  leadId: \"lead_123\",\n  message: \"Hi John, following up on our conversation...\"\n});",
            },
            {
              name: 'getAllSenderAccounts',
              description: "Get all LinkedIn sender accounts",
              signature: 'getAllSenderAccounts(options?)',
              example: "const accounts = await getAllSenderAccounts({ keyword: \"john\", limit: 10 });",
            },
            {
              name: 'getSenderById',
              description: "Get specific sender account details",
              signature: 'getSenderById(options)',
              example: "const sender = await getSenderById({ senderId: 123 });",
            },
            {
              name: 'getMyNetworkForSender',
              description: "Get network profiles/connections for a LinkedIn account",
              signature: 'getMyNetworkForSender(options)',
              example: "const network = await getMyNetworkForSender({ senderId: 123, offset: 0, limit: 50 });",
            },
            {
              name: 'getOverallStats',
              description: "Get comprehensive analytics and statistics",
              signature: 'getOverallStats(options)',
              example: "const stats = await getOverallStats({\n  campaignIds: [90486],\n  startDate: \"2025-01-01T00:00:00Z\",\n  endDate: \"2025-01-31T23:59:59Z\"\n});\nconsole.log(stats.overallStats.acceptanceRate, stats.overallStats.replyRate);",
            },
            {
              name: 'createWebhook',
              description: "Set up event-based callbacks",
              signature: 'createWebhook(options)',
              example: "const webhook = await createWebhook({\n  name: \"Lead Reply Webhook\",\n  url: \"https://your-server.com/webhooks/heyreach\",\n  eventType: \"MESSAGE_REPLY_RECEIVED\",\n  campaignIds: [90486]\n});",
            },
            {
              name: 'getWebhookById',
              description: "Get webhook details by ID",
              signature: 'getWebhookById(options)',
              example: "const webhook = await getWebhookById({ webhookId: \"webhook_789\" });",
            },
            {
              name: 'updateWebhook',
              description: "Update webhook settings (enable/disable)",
              signature: 'updateWebhook(options)',
              example: "await updateWebhook({ webhookId: \"webhook_789\", active: false });",
            },
            {
              name: 'deleteWebhook',
              description: "Delete a webhook",
              signature: 'deleteWebhook(options)',
              example: "await deleteWebhook({ webhookId: \"webhook_789\" });",
            },
          ],
        },
        {
